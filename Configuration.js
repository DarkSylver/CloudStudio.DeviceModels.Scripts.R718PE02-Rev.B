...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("2", "Status", endpointType.appliance);
    ...
    var strength = endpoints.addEndpoint("5", "Sensor Strength", endpointType.genericSensor);
    strength.variableTypeId = 1283;
}
