...
# Parsing + Configuration Script – R718PE02 - Rev. B

This **Parsing + Configuration** script is designed for the **R718PE02** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – R718PE02 Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **R718PE02** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
